...
const (
	FinalizerString = "finalizers.cloudfront.fork.services.k8s.aws/CachePolicy"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("cachepolicies")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.CachePolicy{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.CachePolicy),
	}
}
