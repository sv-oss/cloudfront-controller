...
const (
	FinalizerString = "finalizers.cloudfront.fork.services.k8s.aws/Distribution"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("distributions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.Distribution{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.Distribution),
	}
}
