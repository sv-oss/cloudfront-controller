...
const (
	FinalizerString = "finalizers.cloudfront.fork.services.k8s.aws/OriginRequestPolicy"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("originrequestpolicies")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.OriginRequestPolicy{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.OriginRequestPolicy),
	}
}
