...
const (
	FinalizerString = "finalizers.cloudfront.fork.services.k8s.aws/VPCOrigin"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("vpcorigins")
